...
def family_graph():
    ...
    gd.configure_pagination(enabled=True, paginationAutoPageSize=False, paginationPageSize=50)
    ...
    #         st.table(family_df[sel_row_df])
            # if button_delete:
            #     family_df_edited = family_df[family_df]
    # st.write(family_df)
